...
export default function VendorProductForm({
  ...
  const [formData, setFormData] = useState<ProductFormState>({
    ...
    shopSellPrice: product?.shopSellPrice?.toString() || "",
  ...
  const loadProductData = useCallback(async () => {
    ...
    try {
      ...
      setFormData({
        ...
        shopPrice: productData.shopPrice?.toString() || "",
        shopSellPrice: productData.shopSellPrice?.toString() || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (product) {
        ...
        await api.post("/products/vendor", formDataToSend, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      }
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="shopPrice">
                    My Price (<span className=" text-red-600">BDT</span>) *
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="shopSellPrice">
                    Sell Price (<span className=" text-red-600">BDT *</span>)
                  </Label>
                  <div className="relative">
                    <Input
                      id="shopSellPrice"
